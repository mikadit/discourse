...
class Reviewable < ActiveRecord::Base
  ...
  def add_score(user, reviewable_score_type, created_at: nil, take_action: false)
    ...
    self.latest_score = rs.created_at
    save
  end
  ...
  def self.list_for(user, status: :pending, type: nil, limit: nil)
  ...
  def counts_updated(performed_by)
  end
